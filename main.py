...
if __name__ == '__main__':
    ...
    with open('crema-processed-dataset.pkl', 'rb') as f:
        data = pickle.load(f)
    print(data.columns)
    listOfWER = []
    ...
    for number in range(len(data.index)):
        ...
        WER = wer(groundTruth, S2T)
        listOfWER.append(wer(groundTruth, S2T))
        # if WER == '0.00%':
    ...
    pickle.dump(data, open("crema-processed-dataset-with-WER.p", "wb"))
